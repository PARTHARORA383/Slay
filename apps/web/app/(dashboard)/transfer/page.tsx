...
export default  function() {
    ...
    return <div className="lg:ml-[270px] lg:mr-[20px] ">
        <div className=" text-3xl lg:text-4xl text-neutral-100 text-bold ml-2 lg:mt-14 mt-8">Transfer</div>
        <div className="lg:mt-10 grid grid-cols-1 lg:grid-cols-3 lg:gap-4">
            ...
            <div className=" order-1 lg:order-2 col-span-3 lg:col-span-1 flex flex-col ">
                ...
                <div className="hidden lg:block bg-neutral-950 bg-opacity-30  rounded-lg mt-5 h-24 p-3 text-neutral-100 text-lg font-mono ">
